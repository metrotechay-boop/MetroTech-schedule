...
const schedule = {
  stations: [
    ...
    { id:'year3', title:'שנה ג׳', subtitle:'העמקת התשלבות', icon:'◆', intro:'התמחות, פורטפוליו וחיבור לתעשייה' },
  ...
  scholarships: [
    { date:'2026-11-25', title:'מלגת קיום', text:'עד 25.11 בכל חודש · 3,000 ₪ לחודש' },
